-- DropIndex
DROP INDEX `CashFlowEntry_categoryId_fkey` ON `cashflowentry`;
...
-- AlterTable
ALTER TABLE `cashflowentry` ADD COLUMN `operatorId` INTEGER NULL,
...
CREATE TABLE `FinancialLog` (
    ...
    INDEX `FinancialLog_timestamp_idx`(`timestamp`),
    PRIMARY KEY (`id`)
